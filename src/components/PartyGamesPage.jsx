...
const gameCategories = [
  {
    ...
    img: '/images/stick-figures/competitive.svg',
    imgAlt: 'Stick figure characters being excited and competitive.',
    games: [
      {
  ...
  },
  {
    ...
    img: '/images/stick-figures/casual.svg',
    imgAlt: 'Stick figure characters enjoying a relaxed gaming session.',
    games: [
      {
        name: 'Wii Sports',
  ...
  },
  {
    ...
    img: '/images/stick-figures/4-player.svg',
    imgAlt: '4 stick figure characters in a circle.',
    games: [
      {
        name: 'Mario Party 8',
  ...
  },
  {
    ...
    img: '/images/stick-figures/date-night.svg',
    imgAlt: '2 stick figure characters with a heart between them.',
    games: [
      {
        name: 'Mario Kart Wii',
...
const partyFaqs = [
  {
    ...
    a: '<b>4 players maximum</b> with smartphone controllers connected at once. That\'s the limit of the console.'
  },
  {
        ...
        <div class="container">
          <div class="party-hero-content">
            <div class="party-hero-text">
              ...
              <h1>Best Party Games for Groups</h1>
              <p class="lead">
                Those classic games you grew up with are still the best for getting people together to play. BeckerBox lets you play them on your PC using phones as controllers. No console, no expensive controllers, no complicated setup.
              </p>
              <div class="party-hero-cta">
                <a class="btn primary" href="/download.html">Download BeckerBox to Play!</a>
      ...
      <section class="section" style="padding: 0;">
        <div class="container">
          <div style="
            ...
            font-size: 0.9rem;
            color: var(--muted);
            border-left: 3px solid rgba(25, 194, 101, 0.35);
            padding: 8px;
            padding-left: 10px;
                ...
                <section class={`party-game-comparison ${index() % 2 === 1 ? 'reverse' : ''}`}>
                  <div class="party-game-comparison-content">
                    ...
                    <div class="party-game-media">
                      <img src={category.img} alt={category.imgAlt} />
                    </div>
                  </div>
                </section>
              )}
